...
func initAPI() {
	...
	beego.Router("/api/get-website-knowledges", &controllers.ApiController{}, "GET:GetWebsiteKnowledges")
	beego.Router("/api/get-website-knowledge", &controllers.ApiController{}, "GET:GetWebsiteKnowledge")
	...
	beego.Router("/api/learn-website-from-message", &controllers.ApiController{}, "POST:LearnWebsiteFromMessage")
	beego.Router("/api/consolidate-website-memory", &controllers.ApiController{}, "POST:ConsolidateWebsiteMemory")
	beego.Router("/api/update-website-knowledge", &controllers.ApiController{}, "POST:UpdateWebsiteKnowledge")
