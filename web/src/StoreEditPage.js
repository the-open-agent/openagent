    ...
    return (
      <div>
        ...
        <Card size="small" title={renderCardTitle(i18next.t("store:Agent Profile"), i18next.t("store:Agent Profile desc"))} style={sectionCardStyle} headStyle={cardHeadStyle}>
          <Row gutter={rowGutter}>
            {this.renderStoreField(
              Setting.getLabel(i18next.t("store:Hub author"), i18next.t("store:Hub author - Tooltip")),
            ...
            {this.renderStoreField(
              Setting.getLabel(i18next.t("store:Hub description"), i18next.t("store:Hub description - Tooltip")),
